...
open class RadarChartRenderer: LineRadarRenderer
{
    ...
    open override func drawData(context: CGContext)
    {
        ...
        for radar in radarData.dataSets where radar.isVisible {
            if let radarSet = radar as? RadarChartDataSetProtocol {
                drawDataSet(context: context, dataSet: radarSet, mostEntries: mostEntries)
            }
        }
//
